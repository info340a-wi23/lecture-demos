...
// //Slide 5 using an inline expression 
// const titleMessage = "Hello Word!!!";
// const reactElem = <h1>{titleMessage.toUpperCase()}</h1>
// const root = ReactDOM.createRoot(document.getElementById('root'));
// root.render(reactElem);

// //Slide 5a (little more complex, add the header), change 'class' to 'className'
...
// //Slide 8 - Lets do this as a react component
...
//Slide 14A - Making modular components
