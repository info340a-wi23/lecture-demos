...
// // Slide 16 use the json object to fill things out and add logic to the component
...
// // Slide 19 - now use the json object to fill this out with mapping
// import COURSE_DATA from './course-data.json';
